 ...
 * @version $Id: Backup.php 35652 2012-06-14 12:44:10Z zhangweiwen $
 */
 ...
 * @name ZtChart_Model_Monitor_Daemon_Backup
 */
final class ZtChart_Model_Monitor_Daemon_Backup extends ZtChart_Model_Monitor_Daemon_Abstract {
    ...
    public function run() {
        ...
        while (true) {
            if (date($this->_pattern) == date($this->_pattern, $this->_timestamp)
                || date($this->_pattern, $this->_console->getEndTimestamp()) 
                    == date($this->_pattern, $this->_timestamp)) {
                break;
            }
