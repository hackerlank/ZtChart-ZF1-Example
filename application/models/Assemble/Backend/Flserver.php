 ...
 * 登陆日志数据装载器
 *
 * @name ZtChart_Model_Assemble_Backend_Flserver
 */
class ZtChart_Model_Assemble_Backend_Flserver extends ZtChart_Model_Assemble_Backend_Flserver_Abstract {
    ...
    public function __construct() {
        $this->_tableDAO = new ZtChart_Model_DbTable_Flserver();
    }
    ...
    public function columns($asLabel, $asData) {
        ...
        $select->columns("flserver_datetime AS {$asLabel}")->columns("COUNT(*) AS {$asData}");
